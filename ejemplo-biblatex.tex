...
%  Ejemplo con bibliografia en .bib (biblatex-apa). Compilar con:
%  latexmk ejemplo-biblatex.tex
...
% Base bibliografica en APA 7. Sin la opcion [biblatex] del \documentclass,
% las referencias se escriben a mano en el entorno {referencias}.
