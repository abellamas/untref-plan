...
En primer lugar debe definirse si se recurrirá a una muestra probabilística o no probabilística, la cantidad de sujetos que se encuestarán, y la justificación de esa decisión. Aquí debe desarrollarse también de modo completo el cuestionario y el desarrollo de la encuesta, es decir definir las preguntas, las muestras que se presentarán a los encuestados, las series de pruebas, duración, etc. Debe incluso definirse con exactitud el recorrido que hará cada encuestado, el lugar, las características del equipamiento a emplear, etc.
...
Aletta, F., Xiao, J., \& Kang, J. (2024). Navigating soundscape standardization: Understanding barriers to the ISO 12913 implementation. \textit{Proceedings of Inter-Noise 2024}, Nantes, France.

International Organization for Standardization. (2014). \textit{Acoustics --- Soundscape --- Part 1: Definition and conceptual framework} (Standard No.\ ISO 12913-1:2014).
